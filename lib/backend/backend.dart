...
import 'schema/shop_places_record.dart';
import 'schema/health_places_record.dart';
...
export 'schema/shop_places_record.dart';
export 'schema/health_places_record.dart';
...
/// Functions to query ShopPlacesRecords (as a Stream and as a Future).
Future<int> queryShopPlacesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ShopPlacesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ShopPlacesRecord>> queryShopPlacesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ShopPlacesRecord.collection,
      ShopPlacesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ShopPlacesRecord>> queryShopPlacesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query HealthPlacesRecords (as a Stream and as a Future).
Future<int> queryHealthPlacesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      HealthPlacesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<HealthPlacesRecord>> queryHealthPlacesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      HealthPlacesRecord.collection,
      HealthPlacesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<HealthPlacesRecord>> queryHealthPlacesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<int> queryHealthRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      HealthRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
