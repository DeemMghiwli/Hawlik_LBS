...
class ShopDetailsWidget extends StatefulWidget {
  ...
  final DocumentReference? shopPara;
            ...
            children: [
              Expanded(
                child: Padding(
                  ...
                  child: StreamBuilder<ShopPlacesRecord>(
                    stream: ShopPlacesRecord.getDocument(widget.shopPara!),
                    builder: (context, snapshot) {
                      ...
                      final columnShopPlacesRecord = snapshot.data!;
                          ...
                          children: [
                            Container(
                              ...
                              child: Builder(builder: (context) {
                                final _googleMapMarker =
                                    columnShopPlacesRecord.location;
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  4.0, 4.0, 0.0, 0.0),
                              child: Text(
                                columnShopPlacesRecord.description,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Plus Jakarta Sans',
