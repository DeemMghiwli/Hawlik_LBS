...
class FoodDetailsWidget extends StatefulWidget {
  const FoodDetailsWidget({
    Key? key,
    required this.foodPara,
  }) : super(key: key);

  final DocumentReference? foodPara;
              ...
              Expanded(
                child: Padding(
                  ...
                  child: StreamBuilder<FoodRecord>(
                    stream: FoodRecord.getDocument(widget.foodPara!),
                    builder: (context, snapshot) {
                      ...
                      final columnFoodRecord = snapshot.data!;
